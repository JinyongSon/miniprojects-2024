    ...
    public partial class RealTimeControl : UserControl
    {
        ...
        private void UpdateChart(string payload)
        {
            this.Invoke(() =>
            {
                ...
                var tempVal = GaugeGenerator.BuildSolidGauge(new GaugeItem(temp,
                    Series =>
                    {
                        Series.MaxRadialColumnWidth = 50;
                        Series.DataLabelsSize = 50;
                    }));
                ChtLivingTemp.Series = ChtDinningTemp.Series = ChtBedTemp.Series = ChtBathTemp.Series = tempVal; // 차트 네개다 같은 값을 할당
